...
const WGTreasures = () => {
    ...
    return (
        <WGTreasuresBox>
            <TitleBox>
                <Title variant="primaryText" color="textPrimary" >WG Treasures</Title>
            </TitleBox>
            <AccordionFilter filterTitle={"Traditional Medicine"} filterOptions={["Acupuncture","Ayurveda","Acupuncture"]}  aria-controls="panel1a-content"
                id="panel1a-header" />
            <AccordionFilter filterTitle={"Traditional Medicine"} filterOptions={["Acupuncture","Ayurveda","Acupuncture"]}  aria-controls="panel2a-content"
                id="panel2a-header" />
