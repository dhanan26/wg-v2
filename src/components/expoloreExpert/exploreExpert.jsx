...
const ExploreDropdownBox = ({ items, placeholder, label }) => {
    return (
        <Stack >
            <DropDownTitleBox>
...
export const ExploreExpert = () => {
    return (
        <ExploreExpertBox>
            <Title variant="primaryTitle" color="secondary"  > Explore Experts For Upper Back Treatment</Title>
            <MainContainer>
            <InputContainer>
            ...
            <ButtonContainer>
                <SearchButton variant="contained" color="buttonSecondary" >Search</SearchButton>
